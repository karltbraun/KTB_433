""" periodic_scanning.py
    ...
    ** incorporates process loop which
        scans and publishes for a specified period of time, then
        sleeps for a specified period of time (letting receiver cool down)
"""
import sys
import json
import time
